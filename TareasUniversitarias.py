...
class ProfileSetup:
    ...
    def _crear_contenido(self):
        ...
        card = ctk.CTkFrame(self.scrollable_frame, corner_radius=15)
...
class App:
    ...
    def _construir_encabezado(self):
        ...
        clock_frame.grid(row=0, column=1, sticky="e", padx=20, pady=20)
    ...
    def _construir_panel_inputs(self):
        ...
        left.grid(row=0, column=0, sticky="ew", padx=20, pady=16)
        ...
        center.grid(row=0, column=1, sticky="ew", padx=12, pady=16)

        materia_frame = ctk.CTkFrame(center, fg_color="transparent")
        materia_frame.pack(side="left", fill="both", expand=True, padx=(0, 8))
        ...
        fecha_frame = ctk.CTkFrame(center, fg_color="transparent")
        fecha_frame.pack(side="left", fill="both", expand=True, padx=(0, 8))
        ...
        self.cal = DateEntry(fecha_frame, width=14, font=("Segoe UI", 10))
        self.cal.set_date(datetime.now())
        self.cal.pack(fill="x")

        hora_frame = ctk.CTkFrame(center, fg_color="transparent")
        hora_frame.pack(side="left", fill="both", padx=(0, 8))
        ...
        self.btn_hora.pack(fill="x", expand=True)

        right = ctk.CTkFrame(input_frame, fg_color="transparent")
        right.grid(row=0, column=2, sticky="ew", padx=12, pady=16)
        ...
        filter_frame.grid(row=0, column=3, sticky="ew", padx=20, pady=16)
    ...
    def _construir_tablero(self):
        ...
        for estado in ESTADOS:
            ...
            if col_idx == 0:
                col_frame.grid(row=0, column=col_idx, sticky="nsew", padx=(0, 8))
            elif col_idx == len(ESTADOS) - 1:
                col_frame.grid(row=0, column=col_idx, sticky="nsew", padx=(8, 0))
            else:
